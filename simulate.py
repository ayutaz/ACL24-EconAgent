...
def main(num_agents=100, episode_length=240, dialog_len=3, max_price_inflation=0.1, max_wage_inflation=0.05):
    ...
    obs = env.reset()
    actions = {}
    policy_model_save = f'gpt-{dialog_len}-noperception-reflection-1'
